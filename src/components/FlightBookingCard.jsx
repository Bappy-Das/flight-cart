            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-8 flex-1 justify-center ">
                <div className="text-center">
                  <div className="text-xs text-gray-500 mb-1">{flightInfo.flights[0].flightSegments[0].departure.depDate}</div>
                  <div className="text-xl font-bold text-gray-900">
                    {flightInfo.flights[0].flightSegments[0].departure.depTime}
                  </div>
                  <div className="text-gray-600 font-bold text-xs">
                    {flightInfo.flights[0].flightSegments[0].departure.airport.airportCode}
                  </div>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <div className="text-xs font-medium text-gray-600">{flightInfo.flights[0].totalElapsedTime}</div>
                  <div className="flex items-center gap-2">
                  ...
                  <div className="text-xs text-gray-500">
                    {flightInfo.flights[0].totalStops === 0 ? "Non-stop" : "Has stop(s)"}
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-xs text-gray-500 mb-1">{flightInfo.flights[0].flightSegments[0].arrival.arrDate}</div>
                  <div className="text-xl font-bold text-gray-900">{flightInfo.flights[0].flightSegments[0].arrival.arrTime}</div>
                  <div className="text-gray-600 font-bold text-xs">
                    {" "}
                    {flightInfo.flights[0].flightSegments[0].arrival.airport.airportCode}
                  </div>
                </div>
              </div>
            </div>
